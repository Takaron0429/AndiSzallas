                ...
                <form action="{{ route('foglalas.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 mb-4">
                            ...
                            <div class="selected-dates bg-light p-3 rounded mb-4">
                                <div class="d-flex justify-content-between">
                                    <p class="mb-0"><strong><i class="fa fa-sign-in"></i> Bejelentkezés:</strong> <span id="selected-checkin" class="fw-bold text-primary">-</span></p>
                                    <p class="mb-0"><strong><i class="fa fa-sign-out"></i> Kijelentkezés:</strong> <span id="selected-checkout" class="fw-bold text-primary">-</span></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="specialis_keresek" class="form-label"><i class="fa fa-comment"></i> Speciális kérések:</label>
                                <textarea class="form-control" id="specialis_keresek" name="specialis_keresek" rows="4"></textarea>
                            </div>
                            
                            <div class="alert alert-info">
                                <h5 class="mb-0" id="calculatedPrice">Válassza ki a dátumot és a vendégek számát az ár megjelenítéséhez</h5>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="iranyitoszam" class="form-label"><i class="fa fa-map-pin"></i> Irányítószám</label>
                                    <input type="text" class="form-control" id="iranyitoszam" name="iranyitoszam">
                                </div>
                                <div class="col-md-8">
                                    <label for="lakcim" class="form-label"><i class="fa fa-map-marker"></i> Lakcím</label>
    ...
    <footer>
        <div class="wave-container">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#ffffff" fill-opacity="0.2" d="M0,64L48,85.3C96,107,192,149,288,165.3C384,181,480,171,576,138.7C672,107,768,53,864,74.7C960,96,1056,192,1152,234.7C1248,277,1344,267,1392,261.3L1440,256L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
            </svg>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12" id="contact">
                    ...
                    <p class="strongerp"><i class="fab fa-facebook-f"></i><a class="linktag" href="https://www.facebook.com/profile.php?id=100057090354050"> Facebook - Andi Apartman</a></p>
