...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 31. 21:29
...
(1, 'Takács Áron', 'aron0429', 'takaron0429@gmail.com', '2025-03-31 13:09:07', NULL, NULL),
...
(12, 19, 'Felnőttek és gyerekek száma módosítás', '2025-03-31 15:46:30', 'függőben', NULL, NULL);
...
(5, 5, '2025-05-20', '2025-05-27', 2, 4, 84000.00, 'elfogadva', 'függőben', NULL, 3, NULL, '2025-05-20 08:00:00', '2025-03-26 08:04:22'),
...
(19, 19, '2025-08-01', '2025-08-08', 2, 1, 175000.00, 'elfogadva', 'függőben', NULL, 2, 3, '2025-08-01 08:00:00', '2025-03-31 15:46:30'),
...
(1, 'Balaton Sound Festival', 'sound.jpg', 'Az egyik legismertebb elektronikus zenei fesztivál, Siófok mellett Zamárdiban. A legnagyobb nemzetközi DJ-k és előadók lépnek fel.', 'Zamárdi, Balaton-part', '2025-07-06', '2025-07-09', NULL, NULL, '2025-03-06 09:53:31'),
(2, 'Kövesdi Kézműves Fesztivál', 'kez.jpg', 'A Balaton déli partján, a kis falu, Kövesd rendezvényén a látogatók helyi kézművesek portékáit vásárolhatják meg.', 'Kövesd, Fő tér', '2025-06-10', '2025-06-12', 'http://kovesdikezmufesztival.hu', NULL, NULL),
(3, 'Siófoki Jótékonysági Vásár', 'vasar.jpg', 'A helyi közösség szervezésében jótékonysági vásár, ahol használt ruhák, könyvek és egyéb termékek kaphatók a Balatonparton.', 'Siófok, Fő tér', '2025-05-20', '2025-05-20', 'http://siofok.hu', NULL, '2025-03-06 09:43:41'),
(4, 'Balaton Maraton', 'marathon.jpg', 'Év végi sportesemény, amely egyben a Balaton körüli maratoni futóverseny. A rendezvény mindenki számára elérhető, amatőröktől a profi sportolókig.', 'Balaton, környék', '2025-10-01', '2025-10-01', 'http://balatonmaraton.hu', NULL, '2025-03-06 09:42:16'),
(5, 'Tihanyi Levendula Fesztivál', 'tihany.jpg', 'A levendula szüret idején megrendezett fesztivál Tihanyban, ahol a látogatók élvezhetik a levendula illatát, levendula alapú ételeket és italokat kóstolhatnak.', 'Tihany, Levendula-ház', '2025-06-25', '2025-07-05', 'http://tihanyilevendulafesztival.hu', NULL, NULL),
(6, 'Taste Balaton Fesztivál', 'taste.png', 'A Taste Balaton Fesztivál tíz napon át több mint száz programmal és 20 helyszínen várja a látogatókat, gasztronómiai élményekkel és kulturális eseményekkel.', 'Balaton környéke, különböző helyszínek', '2025-03-07', '2025-03-16', 'https://tastebalaton.hu', NULL, NULL),
(7, 'Művészetek Völgye', 'muveszet.jpg', 'A Művészetek Völgye fesztivál Kapolcs, Taliándörögd és Vigántpetend településeken zajlik, számos kulturális és művészeti programmal.', 'Kapolcs, Taliándörögd, Vigántpetend', '2025-07-18', '2025-07-27', 'https://muveszetekvolgye.hu', NULL, NULL),
(8, 'Paloznaki Jazzpiknik', 'jazz.png', 'A Paloznaki Jazzpiknik három napon át kínál jazz koncerteket és gasztronómiai élményeket a Balaton északi partján.', 'Paloznak, Fő tér', '2025-07-31', '2025-08-02', 'https://jazzpiknik.hu', NULL, NULL),
(9, 'Balatonfüredi Borhetek', 'borhet.jpg', 'A Balatonfüredi Borhetek során a legkiválóbb balatoni borászatok kínálják boraikat, kísérő programokkal és koncertekkel.', 'Balatonfüred, Tagore sétány', '2025-08-08', '2025-08-30', 'https://balatonfurediborhetek.hu', NULL, NULL),
(10, 'Balaton Park Circuit MotoGP', 'moto.jpg', 'A MotoGP 33 év után visszatér Magyarországra, a Balaton Park Circuit ad otthont a versenynek, amely a motorsport rajongók számára kihagyhatatlan esemény.', 'Balatonfőkajár, Balaton Park Circuit', '2025-08-22', '2025-08-24', 'https://balatonparkcircuit.com', NULL, NULL),
(11, 'ZamJam Fesztivál', 'zam.jpg', 'A ZamJam fesztivál három napon át kínál zenét, képzőművészetet, gasztronómiát, gyerekprogramokat és irodalmat Zamárdiban.', 'Zamárdi, Különböző helyszínek', '2024-06-01', '2024-06-03', 'https://zamjam.hu', '2025-03-29 10:07:34', '2025-03-29 10:07:34'),
(12, 'Kőröshegyi Levendulás', 'lev.jpg', 'A Kőröshegyi Levendulásban a látogatók levendulát szedhetnek és különböző levendulás termékeket vásárolhatnak.', 'Kőröshegy, Levendulás', '2024-06-15', '2024-06-30', 'https://koroshegyilevendulas.hu', '2025-03-29 10:07:34', '2025-03-29 10:07:34'),
(13, 'Balatonboglári Szüreti Fesztivál', 'szuret.jpg', 'A Balatonboglári Szüreti Fesztivál Magyarország egyik legnagyobb szüreti fesztiválja, borbemutatókkal, koncertekkel és tűzijátékkal.', 'Balatonboglár, Platán strand', '2024-08-15', '2024-08-20', 'https://balatonboglariszureti.hu', '2025-03-29 10:07:34', '2025-03-29 10:07:34'),
(14, 'Balatonföldvári Halfesztivál', 'hal.jpg', 'A Balatonföldvári Halfesztiválon a látogatók különböző halételeket kóstolhatnak meg, miközben élő zenei programok szórakoztatják őket.', 'Balatonföldvár, Kikötő tér', '2024-07-10', '2024-07-12', 'https://balatonfoldvarihalfesztival.hu', '2025-03-29 10:07:34', '2025-03-29 10:07:34'),
(15, 'Siófoki Pünkösdi Fesztivál', 'punk.jpg', 'A Siófoki Pünkösdi Fesztivál kulturális és szórakoztató programokkal várja a látogatókat a pünkösdi hétvégén.', 'Siófok, Fő tér', '2024-05-18', '2024-05-20', 'https://siofokifesztival.hu', '2025-03-29 10:07:34', '2025-03-29 10:07:34');
...
('nl2e1vAEsgfj1srFeC2fX4ThNqL1zMAHopgmNdpn', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '', 1743449296);
...
--
ALTER TABLE `foglalasi_modositasok`
  MODIFY `modositas_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `helyi_programajanlok`
  MODIFY `program_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
